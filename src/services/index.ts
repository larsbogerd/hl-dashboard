...
export const CONNECTORS: Connector[] = [
    ...
    {name: 'Radarr', url: import.meta.env.VITE_RADARR_URL, fetch: fetchRadarr, interval: 600_000},
    ...
    {name: 'qBittorrent', url: import.meta.env.VITE_QBITTORRENT_URL, fetch: fetchQbittorrent, interval: 2_000},
